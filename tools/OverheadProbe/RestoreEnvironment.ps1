...
param([string] $OriginalAutostartExe = '%USERPROFILE%\Desktop\Pavise.exe')

$scratch = '%USERPROFILE%\AppData\Local\Temp\claude\c--Code-Aegis\47ed3f21-d1b4-4678-96c5-8ab818071ea2\scratchpad'
