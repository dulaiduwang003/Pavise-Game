// Pavise Interrupt Fabric - read-only field feasibility detector.
// It does not tune interrupts, install a driver, inject code, or alter game state.
...
private:
    ...
    void OnEvent(PEVENT_RECORD event) {
        ...
        // PresentHistory_Start (171) is the correct kernel-side start for APIs without
        // DXGI/D3D9 runtime events. Present_Info (184) is an end/correlation event and
        // cannot be treated as a process-owned frame source.
