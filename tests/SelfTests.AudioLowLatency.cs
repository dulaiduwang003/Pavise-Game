// File purpose Pure decision logic checks, no COM activation, no audio devices, no writes at all
// Low-latency audio regression, only verifies the benefit decision and period conversion, no real audio devices
#if PAVISE_SELFTEST
using System;
